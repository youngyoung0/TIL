...
import studyJPA.demo.domain.item.Book;
import studyJPA.demo.domain.item.Item;
import studyJPA.demo.exception.NotEnoughStockException;
...
public class OrderServiceTest {
    ...
    @Test
    public void 상세주문() throws Exception{
        //give
        ...
        assertEquals("주문한 상품 종류 수가 정확해야 하나다", 1, getOrder.getOrderItems().size());
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("서울", "깅남","123-123"));
        em.persist(member);
        return member;
    }
}