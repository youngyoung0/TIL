...
import sample.cafekiosk.spring.api.service.order.response.product.ProductService;
...
class ProductControllerTest {
    ...
    void createProduct() throws Exception {
        // given
        ProductCreateRequest request = ProductCreateRequest.builder().type(ProductType.HANDMADE).sellingStatus(ProductSellingStatus.SELLING).name("아메리카노").price(4000).build();
    ...
    void createProductWithoutType() throws Exception {
        ...
        // when then
        mockMvc.perform(
                MockMvcRequestBuilders.post("/api/v1/products/new").content(objectMapper
